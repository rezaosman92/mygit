{
  ...
  version = "1.11.1";
  system = "x86_64-linux";
  devenv_root = "/home/reza/mygit/nixos/devenv/zig";
  project_input_ref = "path:/home/reza/mygit/nixos/devenv/zig";
  devenv_dotfile = "/home/reza/mygit/nixos/devenv/zig/.devenv";
  devenv_dotfile_path = ./.devenv;
  devenv_tmpdir = "/run/user/1000";
  devenv_runtime = "/run/user/1000/devenv-2825543";
  devenv_istesting = false;
  devenv_direnvrc_latest_version = 1;
  container_name = null;
  active_profiles = [
  ];
  hostname = "nixos-hp845";
  username = "reza";
  git_root = "/home/reza/mygit";
  secretspec = null;
};
    in
    {
